...
# combine into dataframe
econ_data_raw <- data.frame(t, K_0, K_2, K_8)
econ_data <- econ_data_raw %>% 
  pivot_longer(cols = starts_with("K"), names_to = "cc_scenario", values_to = "K")

# plot K
ggplot(data = econ_data, aes(x = t, y = K, color = cc_scenario))+
  geom_line()
```
