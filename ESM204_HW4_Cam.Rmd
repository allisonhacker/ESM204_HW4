...
The present value utility with climate change (T = 4.4) is **198.66**. The present value utility without climate change is **255.27**. The percent loss in present value utility from climate change (L) is **22.18%**. 
...
# Assuming that society will "endure" anything where utility > 0
